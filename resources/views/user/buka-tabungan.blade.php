                ...
                <div class="row" style="padding-top: 50px;">
                    <div class="col-sm">
                        ...
                        <div class="form-group mt-3">
                            <label>NIK</label>
                            <input required name="nik" value="" type="number" class="form-control"
                                id="nik" placeholder="Masukkan NIK Sesuai KTP">
                        </div>
                        <div class="form-group mt-3">
                            <label>Nama Lengkap</label>
                            <input required name="nama" value="" type="text" class="form-control"
                                id="nama" placeholder="Masukkan Nama Lengkap Sesuai KTP">
                        </div>
                        <div class="form-group mt-3">
