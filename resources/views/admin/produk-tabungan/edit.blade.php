        ...
        <section class="section">
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('produk.tabungan.update', $data_tabungan->id) }}" method="POST"
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" required name="judul" id="judul" value="{{ $data_tabungan->judul }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" required name="isi" id="isi" value="{{ $data_tabungan->isi }}"
