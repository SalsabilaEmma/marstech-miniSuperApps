                                        ...
                                        <tbody>
                                            @foreach ($data_vismis as $vismis)
                                                <tr class="text-center">
                                                    ...
                                                    <td>{{ date('d F Y', strtotime($vismis->tanggal)) }}</td>
                                                    <td>{{ $vismis->judul }}</td>
                                                    <td class="text-center">
                                                        {{-- <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                            action="{{ route('vismis.destroy', $vismis->id) }}" method="POST"> --}}
                                                        <button type="button" class="show btn btn-sm btn-outline-info"
                                                            data-id="{{ $vismis->id }}" data-judul="{{ $vismis->judul }}"
                                                            data-isi="{{ $vismis->isi }}">
                                                            <i data-feather="info"></i> Detail
                                                        </button>
                                                        <a href="{{ route('vismis.edit', $vismis->id) }}"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('vismis.store') }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
