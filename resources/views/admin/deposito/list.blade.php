                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                            action="{{ route('buka.deposito.destroy', $deposito->id) }}"
                                                            method="POST">
                                                            {{-- <button type="button"
                                                                class="show btn btn-sm btn-outline-info"
                                                                data-id="{{ $deposito->id }}"
                                                                data-nama="{{ $deposito->nama }}"
                                                                data-produk_layanan="{{ $deposito->produk_layanan }}">
                                                                <i data-feather="info"></i> Detail
                                                            </button> --}}
                                                            <a href="{{ route('buka.deposito.detail', $deposito->id) }}"
