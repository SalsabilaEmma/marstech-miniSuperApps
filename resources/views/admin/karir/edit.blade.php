        ...
        <section class="section">
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('karir.update', $data_karir->id) }}" method="POST"
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" required name="judul" id="judul" value="{{ $data_karir->judul }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <textarea required name="isi" id="isi" class="summernote form-control @error('isi') is-invalid @enderror" placeholder="Deskripsi Berita">{{ $data_karir->isi }}</textarea>
                                        @error('isi')
                                            <small>{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="input-group">
                                        <div class="zoom">
                                            <img id="file" class="profile-user-img img-responsive"
                                                ...
                                                src="{{ url('image/pengumuman-karir/' . $data_karir->file) }}" alt="Karir">
                                        </div>
                                    </div>
                                </div>
