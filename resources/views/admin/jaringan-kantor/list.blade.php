                                        ...
                                        <tbody>
                                            @foreach ($data_jaringan as $jaringan)
                                                <tr class="text-center">
                                                    ...
                                                    <td>{{ date('d F Y', strtotime($jaringan->tanggal)) }}</td>
                                                    <td>{{ $jaringan->judul }}</td>
                                                    <td class="text-center">
                                                        {{-- <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                            action="{{ route('jaringan.destroy', $jaringan->id) }}" method="POST"> --}}
                                                            <button type="button" class="show btn btn-sm btn-outline-info"
                                                                data-id="{{ $jaringan->id }}"
                                                                data-judul="{{ $jaringan->judul }}"
                                                                data-isi="{{ $jaringan->isi }}">
                                                                <i data-feather="info"></i> Detail
                                                            </button>
                                                            <a href="{{ route('jaringan.edit', $jaringan->id) }}"
