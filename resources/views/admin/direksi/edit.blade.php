        ...
        <section class="section">
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('direksi.update', $data_direksi->id) }}" method="POST"
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" required name="judul" id="judul" value="{{ $data_direksi->judul }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <textarea required name="isi" id="isi" class="summernote form-control @error('isi') is-invalid @enderror" placeholder="Deskripsi {{ $title }}">{{ $data_direksi->isi }}</textarea>
                                        @error('isi')
                                            <small>{{ $message }}</small>
                                        @enderror
                                    </div>
