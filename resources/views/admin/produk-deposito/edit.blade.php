    ...
    <div class="main-content">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white">
                ...
                <li class="breadcrumb-item"><a href="{{ route('produk.deposito.list') }}">{{ $title }}</a></li>
        ...
        <section class="section">
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('produk.deposito.update', $data_deposito->id) }}" method="POST"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <textarea type="text" required name="isi" id="isi"
                                            value="{{ $data_deposito->isi }}"
                                            class="summernote form-control @error('isi') is-invalid @enderror">{{ $data_deposito->isi }}</textarea>
                                        @error('isi')
                                            <small>{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="{{ route('produk.deposito.list') }}">
                                        <button type="button"
